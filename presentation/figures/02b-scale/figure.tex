...
\node[anchor=west, font=\fontsize{6.2}{7.4}\selectfont\sffamily\color{inkiii}] at (16,33)
  {share of enrolled};
\node[anchor=west, font=\fontsize{6.2}{7.4}\selectfont\sffamily\color{inkiii}] at (16,29.8)
  {patients affected};

% ---- source -------------------------------------------------------------
\node[anchor=west, font=\fontsize{5.4}{6.4}\selectfont\sffamily\color{inkiv}] at (16,9)
