...
const checkpointRules = (section) => [
  { ruleId: 'PR-0009', matchedOn: 'class', label: 'Chronic immunosuppressants', className: 'Chronic immunosuppressant', classIds: ['L04'], protocolSection: section, rationale: 'Chronic immunosuppressive therapy is prohibited throughout treatment. Immunosuppression opposes the mechanism of checkpoint blockade and may mask immune-related adverse events.', threshold: null, appliesWhen: 'during_treatment', washoutWindow: null },
  { ruleId: 'PR-0021', matchedOn: 'class', label: 'Systemic corticosteroids above 10 mg/day prednisone equivalent', className: 'Systemic corticosteroid', classIds: ['H02'], protocolSection: section, rationale: 'Corticosteroids above the stated threshold are prohibited. Physiologic replacement doses and short courses for non-oncologic indications may be permitted after discussion with the medical monitor.', threshold: '> 10 mg/day prednisone equivalent', appliesWhen: 'during_treatment', washoutWindow: null },
  { ruleId: 'PR-0034', matchedOn: 'class', label: 'Live attenuated vaccines', className: 'Live attenuated vaccine', classIds: null, autoScreened: false, protocolSection: section, rationale: 'Live attenuated vaccines are prohibited within 4 weeks before the first dose and throughout treatment. Inactivated and recombinant vaccines are permitted.', threshold: null, appliesWhen: 'both', washoutWindow: 'Within 28 days of first dose' },
  { ruleId: 'PR-0040', matchedOn: 'class', label: 'Other systemic anticancer therapy', className: 'Antineoplastic agent', classIds: ['L01'], protocolSection: section, rationale: 'No other systemic anticancer therapy may be given while the participant is on study treatment.', threshold: null, appliesWhen: 'during_treatment', washoutWindow: null },
];
