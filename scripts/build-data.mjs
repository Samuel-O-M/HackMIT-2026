...
const checkpointRules = (section) => [
  ...
  { ruleId: 'PR-0040', matchedOn: 'class', label: 'Other systemic anticancer therapy', className: 'Antineoplastic agent', protocolSection: section, rationale: 'No other systemic anticancer therapy may be given while the participant is on study treatment.', threshold: null, appliesWhen: 'during_treatment', washoutWindow: null },
];
